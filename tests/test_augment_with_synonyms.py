...
class TestAugmentation(unittest.TestCase):
    def setUp(self):
        self.pdf_path = 'data/data_aumentation_in_natural_language_processing.pdf'
        self.model_response_path = 'data/model_response.txt'
        self.augmented_response_path = 'data/augmented_response.txt'
        self._check_file_exists(self.pdf_path, "PDF")
    ...
    def test_pdf_exists(self):
        self.assertTrue(os.path.exists(self.pdf_path), f"The PDF file '{
                        self.pdf_path}' does not exist")

    def test_model_response_text_exists(self):
        self.assertTrue(os.path.exists(self.model_response_path), f"The Model response file '{
                        self.model_response_path}' does not exist")
    ...
    def test_synonym_augmentation(self):
        ...
        self.assertTrue(os.path.exists(self.augmented_response_path), f"The augmented response file '{
                        self.augmented_response_path}' was not created")
